...
function placeXOrO(squareNumber) {
    //This condiotion ensures a square has not been selected already.
...
//This function parses the selectedSquares array to search for wil conditions.
...
function audio(audioURL) {
    ...
    //Play metod plays our audio sound.
audio.play();
}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        //This method drwas everything we laid out above.
        c.stroke();
    ...
    animateLineDrawing();
    //This line waits 1 second. Then, clear canvas, resets game, and allows clicking agian.
    setTimeout(function () { clear(); resetGame(); }, 1000);

}
//This function reset the game in the event of a tie or a win.
function resetGame() {
    //This for loop iterates through each HTML sqauere element.
    for ( let i = 0; i < 9; i++) {
